    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-label="Confrontation">
      <div className="modal scene" style={{ borderColor: 'var(--red)' }}>
        <div className="row between">
          <b style={{ fontSize: 17, color: 'var(--red)' }}>⚠️ {f?.name ?? 'Somebody'}{c.war ? ' — this is war' : ''}</b>
          <Info id="confrontation" />
        </div>
        ...
        <p className="tiny muted mt8">Leave it until End Day and they do what they came to do.</p>
      </div>
    </div>
  );
}
