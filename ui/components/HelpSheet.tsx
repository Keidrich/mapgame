    ...
    <Sheet title="How to play" subtitle="The first five minutes" icon="❓" onClose={closeHelp}>
      <div className="help">
        ...
        <ol>
          ...
          <li>The <b>Social</b> tab is everybody you have met: who is family, who are old friends, and a place to keep your own notes on them. Follow a tie and you can walk a whole family across the district.</li>
